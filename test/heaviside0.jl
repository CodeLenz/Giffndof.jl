#
# Test Heaviside0 solution
#
@testset "heaviside0" begin    
    ...
    function f_heaviside0!(t,F::Vector{T}) where T
        ...
        F[1] = Giffndof.Heaviside(t,1.0) - Giffndof.Heaviside(t,2.0)
        F[2] = -Giffndof.Heaviside(t,2.0) + Giffndof.Heaviside(t,3.0)
        F[3] = 2*Giffndof.Heaviside(t,4.0)
    ...
    # Run the test
    function Run_heaviside0(tspan, dt, beta_c, PData::Function )

        # Process the solutions
        T,Y,U = Process( tspan, dt, Example_heaviside0, f_heaviside0!, PData, beta_c)
    ...
    T,Y,U = Run_heaviside0(tspan, dt, beta_c, Problem_Data)
    ...
    T,Y,U = Run_heaviside0(tspan, dt, beta_c, PD)
